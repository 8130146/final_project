...
def main():
    st.title("Shap - Naive Bayes - dataset_short")
    ...
    st.title("Shap - Naive Bayes - dataset_series")

    st.header("Sumário dos valores SHAP para a classe 1 (Ataque DDoS)")
    st.image('images/shap_naiveBayes_series/shap_naiveBayes_series_class1.png')
    ...
    st.subheader(f'Distribuição da Característica: {selected_feature_name}')
    st.image(
        f'images/shap_naiveBayes_series/shap_naiveBayes_series_class1_dependence_feature{selected_feature_index}.png')
